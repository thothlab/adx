...
const ru: Dict = {
  ...
  preview: {
    ...
    no_pdf_viewer: "Эта система не показывает PDF здесь — скопируйте файл на компьютер.",
    pdf_hint: "Пусто? Эта система не показывает PDF здесь — скопируйте файл на компьютер.",
  },
  jobs: {
    title: "Операции",
